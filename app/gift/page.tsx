        ...
        <div className="max-w-3xl mx-auto px-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      >
                        {isSelected ? t('gift_selected') : t('gift_select')}
                      </span>
                    </div>
                  </button>
                )
            ...
            <div className="space-y-5">
              <div>
                <label className="block font-inter text-sm font-semibold text-brown mb-1.5">
                  {t('gift_who')} <span className="text-gold">*</span>
                </label>
                <input
                  type="text"
                  value={recipient}
                  onChange={(e) => setRecipient(e.target.value)}
                  placeholder={t('gift_recipient_ph')}
              ...
              <div>
                <label className="block font-inter text-sm font-semibold text-brown mb-1.5">
                  {t('gift_message')} <span className="text-taupe text-xs font-normal">{t('gift_message_note')}</span>
                </label>
                <textarea
                  value={message}
              ...
              <div>
                <label className="block font-inter text-sm font-semibold text-brown mb-1.5">
                  {t('gift_from_label')} <span className="text-gold">*</span>
                </label>
                <input
                  type="text"
                  value={sender}
                  onChange={(e) => setSender(e.target.value)}
                  placeholder={t('gift_from_ph')}
                  className="w-full rounded-xl border border-gold-pale bg-cream-dark px-4 py-3 font-inter text-sm text-brown placeholder-taupe focus:outline-none focus:ring-2 focus:ring-gold transition"
                />
              </div>
              <div>
                <label className="block font-inter text-sm font-semibold text-brown mb-1.5">
                  {t('gift_phone_label')}{' '}
                  <span className="text-taupe text-xs font-normal">{t('gift_phone_note')}</span>
                </label>
                <input
                  type="tel"
                  value={phone}
          ...
          <section>
            ...
            <div className="rounded-2xl border border-gold-pale bg-cream-dark p-6 mb-6 space-y-3">
              <h3 className="font-playfair text-lg font-semibold text-brown mb-4">{t('gift_summary')}</h3>
              ...
              <div className="flex justify-between font-inter text-sm">
                <span className="text-taupe">{t('gift_to')}</span>
                <span className="text-brown font-medium">{recipient || '—'}</span>
              </div>
              <div className="flex justify-between font-inter text-sm">
                <span className="text-taupe">{t('gift_msg')}</span>
                <span className="text-brown font-medium text-right max-w-[60%] truncate">
                  {message || '—'}
                </span>
              </div>
              <div className="flex justify-between font-inter text-sm">
                <span className="text-taupe">{t('gift_from_label')}</span>
                <span className="text-brown font-medium">{sender || '—'}</span>
              </div>
              {phone && (
                <div className="flex justify-between font-inter text-sm">
                  <span className="text-taupe">{t('gift_phone_label')}</span>
