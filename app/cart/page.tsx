    ...
    return (
      <>
        ...
        <main className="pt-28 pb-20 min-h-screen bg-cream flex flex-col items-center justify-center gap-6">
          ...
          <h2 className="font-playfair text-3xl font-bold text-brown">Your cart is empty</h2>
          <p className="text-brown-light">Looks like you haven&apos;t added anything yet.</p>
          <Link
            href="/shop"
    ...
    <>
      ...
      <main className="pt-28 pb-20 min-h-screen bg-cream">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="font-playfair text-4xl font-bold text-brown mb-10">Your Cart</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm h-fit flex flex-col gap-4">
              ...
              <div className="flex justify-between text-sm text-brown-light">
                <span>Delivery</span>
                <span className="font-semibold text-brown">Calculated at checkout</span>
              </div>
